...
function ensure() {
	...
	oForm.action = "/babyplan/PublicVideoAddServlet";
	oForm.submit();
}
</script>
<script>
...
<form name="frmAction"  method="post" action="" enctype="multipart/form-data">
	<table width="60%" align="center">
			...
			<tr>
				<td width="150" align="right" height="40">选择文件：</td>
				<td><input type="file" value="选择文件" name="publicVideoURL"></td>
			</tr>
			<tr>
				<td width="150" align="right" height="40">选择缩略图：</td>
				<td><input type="file" value="选择缩略图" name="publicThumbnail"></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr bgcolor="#E4E4E4">
				<td colspan="2" height="40" align="right" style="text-indent: 1em;">
					...
					<input type="button" name="test" value="返回" onclick="javascript:location.href='/babyplan/PublicVideoListServlet'" style="width:80px;"/>
				</td>
			</tr>
	</table>
</form>
