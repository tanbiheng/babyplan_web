...
@WebServlet("/PublicVideoListServlet")
public class PublicVideoListServlet extends HttpServlet {
...
//		String classNumber1 = classes1.getClassNumber();
		...
		int records = publicVideoService.getPublicVideoNumber();
		int pageSize = 1;
		int totalPage = 0;
		...
		List<PublicVideo> publicVideos = publicVideoService.getPagePublicVideo(curPage, pageSize);
...
//		}
		System.out.println(publicVideos);
...
//		request.setAttribute("classes", classes);
		...
		request.getRequestDispatcher("/page/video/publicList.jsp").forward(request, response);
	}
