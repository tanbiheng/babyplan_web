...
public class CourseEditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String courseClassId = request.getParameter("chkCourseClass");
		...
		request.setAttribute("courseClassId", courseClassId);
		request.setAttribute("teacherNumber", teacherNumber);
		request.setAttribute("classes", classes);
		request.setAttribute("courses", courses);
		request.getRequestDispatcher("/page/classes/course_classEdit.jsp").forward(request, response);
	}
