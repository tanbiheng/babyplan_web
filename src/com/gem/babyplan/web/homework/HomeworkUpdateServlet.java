...
@WebServlet("/HomeworkUpdateServlet")
@MultipartConfig
public class HomeworkUpdateServlet extends HttpServlet {
...
//		String hwStatus = request.getParameter("");
		...
		Homework homework = homeworkService.getHomeworkByHomeworkId(Integer.parseInt(hwId));
