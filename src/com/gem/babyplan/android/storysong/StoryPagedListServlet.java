...
/**
 * Servlet implementation class StoryPagedListServlet
 */
@WebServlet("/StoryPagedListServlet")
public class StoryPagedListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//得到所有对象,由于默认的每页展示的页数是3，设置一个变量为当前页数
				...
				//1是故事。
				List<StorySong> list =sss.getPagedStorySongByType(currPage, ConstantBabyPlan.RECODE_SHOW_NUM, 1);
